...
# Download do dataset
data <- read_excel("D:/Users/cynth/Desktop/FGV/Métodos Matriciais e Análises de Clusters/Trabalho/DadosRioDoce.xlsx", sheet = "2014")
glimpse(data)
summary(data)
...
pairs.panels(data_cleaned[,c(1,4,5,7,9, 11, 13)], 
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = TRUE,  # show density plots
             ellipses = TRUE # show correlation ellipses
...
fviz_contrib(pca, choice = "var", axes = 1:6, top = 13)
