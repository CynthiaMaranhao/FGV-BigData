...
# Download do dataset
data <- read_excel("D:/Users/cynth/Desktop/FGV/Métodos Matriciais e Análises de Clusters/Trabalho/DadosRioDoce.xlsx", sheet = "2015-2016_3")
summary(data)
...
pairs.panels(data_cleaned[,c(2, 7, 9, 11, 13)], 
             method = "pearson", # correlation method
             hist.col = "#00AFBB",
             density = TRUE,  # show density plots
             ellipses = TRUE # show correlation ellipses
